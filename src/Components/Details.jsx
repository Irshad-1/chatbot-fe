    ...
    <>
      ...
      >
        <Box width="40%" margin="40px auto" position="relative">
          ...
          <Heading size="lg" color="#256D85">{`Name:    ${
            data?.name || ''
          }`}</Heading>
          <Heading size="lg" color="#256D85">{`Age:    ${
            data?.age || ''
          }`}</Heading>
          <Heading size="lg" color="#256D85">{`Gender:    ${
            data?.gender || ''
          }`}</Heading>
          <Heading size="lg" color="#256D85">{`Role:    ${
            data?.role || ''
          }`}</Heading>
          <Heading size="lg" color="#256D85">{`Email:    ${
            data?.email || ''
          }`}</Heading>
        </Box>
        <Box
